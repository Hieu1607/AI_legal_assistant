...
def test_happy_case_1_step(client, mock_search):
    with mock_search:
...
def test_happy_case_2_steps(client, mock_search, mock_ask):
    with mock_search:
        with mock_ask:
            response = client.post(
                "/agent",
...
def test_happy_case_3_steps(client, mock_search, mock_ask):
...
def test_timeout_in_step_1(client, mock_ask):
...
def test_timeout_in_step_2(client, mock_search):
    with mock_search:
...
def test_timeout_in_step_3(client, mock_search, mock_ask):
    with mock_search & mock_ask:
...
def test_empty_chunks_in_step_2(client, mock_search, mock_ask):
    with mock_search & mock_ask:
...
def test_not_answer_in_step_3(client, mock_search, mock_ask):
    with mock_search, mock_ask:
...
def test_other_errors(client, mock_search):
    with mock_search:
